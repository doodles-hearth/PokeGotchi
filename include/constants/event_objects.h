...
enum
{
    ...
    OBJ_EVENT_GFX_PG_PORYGON,
    OBJ_EVENT_GFX_PG_TRUBBISH,
    OBJ_EVENT_GFX_PG_SLOWPOKE,
    OBJ_EVENT_GFX_PG_SKITTY,
    OBJ_EVENT_GFX_PG_HYPNO,
    OBJ_EVENT_GFX_PG_TANGELA,
    OBJ_EVENT_GFX_PG_VANILLISH,
    OBJ_EVENT_GFX_PG_ICE_CREAM,
    OBJ_EVENT_GFX_PG_CAR,
    OBJ_EVENT_GFX_PG_CHANSEY,
    OBJ_EVENT_GFX_PG_TORCHIC,
    OBJ_EVENT_GFX_PG_LAMPPOST,
    OBJ_EVENT_GFX_PG_DITTO,
    OBJ_EVENT_GFX_PG_SHUCKLE,
    NUM_OBJ_EVENT_GFX,
};
...
#define OBJ_EVENT_PAL_TAG_POKEGOTCHI              0x1134
