...
const u16 gMetatiles_Tamatown[] = INCBIN_U16("data/tilesets/primary/tamatown/metatiles.bin");
const u16 gMetatileAttributes_Tamatown[] = INCBIN_U16("data/tilesets/primary/tamatown/metatile_attributes.bin");
